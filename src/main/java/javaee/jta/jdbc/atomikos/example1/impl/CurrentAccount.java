...
public class CurrentAccount extends LocalAccount {
	...
	public DataSource getDataSource() {	
		...
		if (ds == null) {
	        ...
	        p.setProperty("databaseName", "javaee_jta_jdbc_atomikos_example1");        
	         ...
	         */
	        //p.setProperty("url", "jdbc:postgresql://localhost:5432/javaee_jta_jdbc_atomikos_example1?user=root&password=");
